...
<head>
  ...
  <title><%=pageContext.getAttribute("website_title")%> - Index</title>
...
<body>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>We are team of highly skilled professionals in workplace services and cloud services</h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <p class="font-italic">
              <%=pageContext.getAttribute("website_title")%> is best known for delivering corporate training to many startups and individuals with experienced industry experts.
